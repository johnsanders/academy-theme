				...
				<div className="row">
					...
					<div className="col-12 col-md-4 featureRowItem">
						...
						<ul className="text-left">
							...
							<li>
								CNN trained CCTV&apos;s English-language channels on creating multiplatform content
					...
					<div className="col-12 col-md-4 featureRowItem">
						...
						<ul className="text-left">
							<li className="mb-3">
								CNN partners with universities around the world to deliver Bootcamps and
