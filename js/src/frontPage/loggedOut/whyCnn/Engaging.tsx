		...
		<div className="container">
			<div className="row">
				...
				<div className="row align-items-center">
					<div className="col-12 col-md-4 featureRowItem d-relative text-left mb-5 mb-md-0">
						...
						<div className="d-flex align-items-center mb-5">
							...
							<h5>
								<em>
									Had the right balance between live seminars and self-learning courses on CNN
									Academy Hub
								</em>
							</h5>
						</div>
						<div className="d-flex align-items-center">
							...
							<h5>
								<em>
									In all honesty, I could write pages upon pages on what I&apos;ve learned during
									the program
								</em>
							</h5>
						</div>
					...
					<div className="col-12 col-md-4 featureRowItem" style={{ border: 'none' }}>
						<div className="text-left">
							...
							<h5 className="mb-4">
								Participants believe program enhanced their journalism skills
							</h5>
						</div>
						<div className="text-left">
							<h1 className="fontBlack mb-0" style={{ color: '#CC0000' }}>
					...
					<div className="col-12 col-md-4 featureRowItem">
						<ul className="text-left">
							<li className="mb-3">
								Our curriculum combines virtual live seminars with engaging courses on journalism
								best practices
							</li>
							<li>
