		...
		<div className="container-fluid">
			<div className="row">
				...
				<div className="col-12 col-md-6">
					...
					<div>
						storytelling. CNN Academy Abu Dhabi is a full-time five-week course. Successful
						applicants will have to attend online lectures and in-person workshops throughout the
						duration of the program, while adhering to any and all social distancing rules that
						might be in place in January 2021.
					</div>
